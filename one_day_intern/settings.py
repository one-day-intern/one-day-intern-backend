...
GOOGLE_AUTH_LOGIN_REGISTER_ASSESSEE_REDIRECT_URI = os.getenv('GOOGLE_AUTH_LOGIN_REGISTER_ASSESSEE_REDIRECT_URI')
...
GOOGLE_AUTH_CLIENT_ASSESSOR_REGISTER_CALLBACK_URL = os.getenv('GOOGLE_AUTH_CLIENT_ASSESSOR_REGISTER_CALLBACK_URL')
