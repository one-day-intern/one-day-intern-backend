...
GOOGLE_AUTH_LOGIN_ASSESSEE_REDIRECT_URI = os.getenv('GOOGLE_AUTH_LOGIN_ASSESSEE_REDIRECT_URI')
...
GOOGLE_AUTH_CLIENT_ASSESSEE_CALLBACK_URL = os.getenv('GOOGLE_AUTH_CLIENT_CALLBACK_URL')
